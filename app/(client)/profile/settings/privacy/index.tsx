// Ruta: /(client)/profile/settings/privacy
// Índice de "Privacidad y Legales" — misma UI que el profesional.
...
export default function PrivacySettingsScreen() {
  const handleSelect = (key: PrivacyMenuOption) => {
    router.push(`/(client)/profile/settings/privacy/${key}` as never);
  };
