// Ruta: /(professional)/profile/settings/account
// Índice de "Más opciones" — 4 entradas (FAQ, Notificaciones, Contactar, Eliminar).
...
export default function AccountSettingsScreen() {
  const handleSelect = (key: AccountMenuOption) => {
    router.push(`/(professional)/profile/settings/account/${key}` as never);
  };
