// Ruta: /(professional)/settings/account/contact
// Opciones de contacto con el equipo — WhatsApp + email (+ redes futuras).
  ...
  return (
    ...
    >
      ...
      <View style={styles.texts}>
        ...
        <Text style={[typography.caption, styles.detail]}>{detail}</Text>
      </View>
