...
export const strings = {
  ...
  proSetup: {
    ...
    professionalArea:          "ÁREAS DE ESPECIALIZACIÓN",
    professionalAreaHelp:      "Podés elegir más de una — mostramos hasta 3 como etiquetas en tu perfil.",
    professionalAreaPlaceholder: "Seleccioná tus áreas...",
    professionalAreaEmpty:     "Aún no elegiste ninguna",
    professionalAreaDone:      "Listo",
