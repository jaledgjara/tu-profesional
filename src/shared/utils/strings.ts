...
export const strings = {
  ...
  auth: {
    ...
    splashSubtitle:    'Tu Profesional te conecta con expertos de confianza\nen tu zona.',
    splashCta:         'Continuar con Email',
    splashSecurity:    'Seguridad y Privacidad',
    splashPrivacyNote: 'Al continuar, aceptás nuestros Términos de Servicio y Política de Privacidad.',
    ...
    roleSubtitle:      'Personalizaremos tu experiencia según cómo quieras usar la plataforma.',
    roleUser:          'Cliente',
  ...
  proSetup: {
    ...
    descriptionPlaceholder: 'Contanos sobre tu formación, especialidades y enfoque terapéutico...',
